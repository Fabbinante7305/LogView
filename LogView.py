...
YOU ARE WARM AND COZY IN YOUR HOBBIT HOLE
STAY A WHILE AND LOG YOUR DAY""")
 ...
 JJ," /   |_  [   ]     _]|   /
  ...
  JJ     |      |\         |,/
   ...
   JJ    /_     ||       ;_|
    ...
    prRed("YOU HAVE ALREADY LOGGED TODAY SIR")
    prRed("COME BACK TOMORROW")
...
def pastEntryMenu():
 ...
 .    '                   .  "   '
    ...
    "`       .   .
                                     '     '
  .    '      _______________
          ==c(___(o(______(_()    FIND A PAST ENTRY AMONG THE STARS
                  \=\
                   )=\
                  //|\\
                 //|| \\
...
def searchMenu():
   ...
   / / /           >> Chester Rider Piper
  / / /              
 / / /             "::" to enter SEARCH command prompt
/ / /
\/_/""")
